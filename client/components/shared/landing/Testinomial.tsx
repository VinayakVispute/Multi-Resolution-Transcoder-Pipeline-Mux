...
const Testimonial = () => {
    return (
        <div className="py-16">
            <SectionHeader
                title="Loved by Individuals and"
                highlightedText="Organizations"
                description="Join over 100,000 satisfied users who rely on our platform for their digital solutions, from personal projects to large-scale enterprise needs."
            />
